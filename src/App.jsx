  ...
  return (
    <>
      ...
      <ul class="font-ceveat text-2xl text-md space-y-1 list-disc list-inside ml-3">
        ...
        <li>
          Just want a machine? Follow the tutorials. Want to learn? Remix my
          projects, build something cooler, or give feedback
        </li>
      </ul>

      <h2 class="text-2xl font-medium text-heading mt-10">
       Tool Requirements 
      </h2>
